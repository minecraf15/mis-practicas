...
class MenuScreen(tk.Frame):
    def __init__(self, master):
        ...
        self.asudhaius = tk.Menu(self.menu_bar, tearoff=0)
        self.asudhaius.add_command(label="Vip", command=self.Vip)
        self.asudhaius.add_command(label=" ", command=self.quit_program)
        self.menu_bar.add_cascade(label="vip", menu=self.asudhaius)
        ...
        self.button = tk.Button(self, text="Presionar", command=self.press_button,bg="pink")
        self.button.pack()
        self.button=tk.Button(self,text=" cerrar secion ",command=self.press_button,bg="red")
        self.button.pack()
        self.pack()
